...
public class Board extends JComponent {
    ...
    public void initGrid()
    {
        ...
        White_Pieces.add(new General(4,0,true,"General.png",this));
        White_Pieces.add(new Guard(3,0,true,"Guard.png",this));
        White_Pieces.add(new Guard(5,0,true,"Guard.png",this));
        White_Pieces.add(new Elephant(2,0,true,"Elephant.png",this));
        White_Pieces.add(new Elephant(6,0,true,"Elephant.png",this));
        White_Pieces.add(new Horse(1,0,true,"Horse.png",this));
        White_Pieces.add(new Horse(7,0,true,"Horse.png",this));
        White_Pieces.add(new Rook(0,0,true,"Rook.png",this));
        White_Pieces.add(new Rook(8,0,true,"Rook.png",this));
        White_Pieces.add(new Cannon(1,2,true,"Cannon.png",this));
        White_Pieces.add(new Cannon(7,2,true,"Cannon.png",this));
        White_Pieces.add(new Pawn(0,3,true,"Pawn.png",this));
        White_Pieces.add(new Pawn(2,3,true,"Pawn.png",this));
        White_Pieces.add(new Pawn(4,3,true,"Pawn.png",this));
        White_Pieces.add(new Pawn(6,3,true,"Pawn.png",this));
        White_Pieces.add(new Pawn(8,3,true,"Pawn.png",this));
        

        Black_Pieces.add(new General(4,9,true,"General.png",this));
        Black_Pieces.add(new Guard(3,9,true,"Guard.png",this));
        Black_Pieces.add(new Guard(5,9,true,"Guard.png",this));
        Black_Pieces.add(new Elephant(2,9,true,"Elephant.png",this));
        Black_Pieces.add(new Elephant(6,9,true,"Elephant.png",this));
        Black_Pieces.add(new Horse(1,9,true,"Horse.png",this));
        Black_Pieces.add(new Horse(7,9,true,"Horse.png",this));
        Black_Pieces.add(new Rook(0,9,true,"Rook.png",this));
        Black_Pieces.add(new Rook(8,9,true,"Rook.png",this));
        Black_Pieces.add(new Cannon(1,7,true,"Cannon.png",this));
        Black_Pieces.add(new Cannon(7,7,true,"Cannon.png",this));
        Black_Pieces.add(new Pawn(0,6,true,"Pawn.png",this));
        Black_Pieces.add(new Pawn(2,6,true,"Pawn.png",this));
        Black_Pieces.add(new Pawn(4,6,true,"Pawn.png",this));
        Black_Pieces.add(new Pawn(6,6,true,"Pawn.png",this));
        Black_Pieces.add(new Pawn(8,6,true,"Pawn.png",this));
